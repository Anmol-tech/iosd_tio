        ...
        slivers: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      ...
                      image: AssetImage(userData.img[index]),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Align(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              userData.likeCount[index].toString(),
                              style:
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        CircleAvatar(
                          backgroundImage:
                              AssetImage(userData.avatarIcon[index]),
                        ),
                        Container(
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        CircleAvatar(
                          backgroundImage:
                              AssetImage(userData.subCommentAvatar[index][idx]),
                        ),
                        Container(
                          margin: EdgeInsets.only(left: 10),
                          padding: EdgeInsets.all(10),
                          ...
                          child: Text(userData.subComment[index][idx]),
                        ),
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        ...
                        FractionalTranslation(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              setState(() {
                                userData.isSubCommnetLiked[index][idx] =
                                    !userData.isSubCommnetLiked[index][idx];
                                if (userData.isSubCommnetLiked[index][idx])
                                  userData.subCommnetLikedCount[index][idx]++;
                                else
                                  userData.subCommnetLikedCount[index][idx]--;
                              });
                            },
                                ...
                                children: [
                                  ...
                                  Text(
                                    userData.subCommnetLikedCount[index][idx] <=
                                            0
                                        ? 'Like'
                                        : userData.subCommnetLikedCount[index]
                                                [idx]
                                            .toString(),
                                    style: TextStyle(fontSize: 12),
                                  ),
              ...
              childCount: userData.subComment[index].length,
            ),
          )
        ],
      ),
